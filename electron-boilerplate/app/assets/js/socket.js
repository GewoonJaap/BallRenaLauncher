      ...
      request(options, (error, response, body) => {
          if(!error && response.statusCode == 200){
              ...
              if(json.login == "success"){
                  ...
                  let win = new BrowserWindow({minWidth: 1280, minHeight: 720, width: 1280, height: 720, frame: true, titleBarStyle: 'hiddenInset', backgroundColor: '#2e2c29' , title:"BallRena Launcher" })
      ...
      request(options, (error, response, body) => {
          if(!error && response.statusCode == 200){
              ...
              if(json.login == "success"){
                ...
                loggersocket.log("Opening main menu....");
                let win = new BrowserWindow({minWidth: 1280, minHeight: 720, width: 1280, height: 720, frame: true, backgroundColor: '#2e2c29' , title:"BallRena Launcher" })
                loggersocket.log("Opening...");
                win.loadURL(`file://${__dirname}/home.html`);
                //Close windows
                var window = remote.getCurrentWindow();
